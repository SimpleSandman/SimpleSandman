...
I am also working on building a [community API](https://github.com/SimpleSandman/UmaMusumeAPI) for a mobile anime game called, [Uma Musume: Pretty Derby](https://umamusume.jp/). I already have a [open-source console app](https://github.com/SimpleSandman/UmaMusumeLoadSqlData) to help load and reload data into either a SQL Server database (which is my preferred RDMS thanks to my DBA days) or MySQL/MariaDB.
