...
I am working on building an API for a mobile anime game called, [Uma Musume: Pretty Derby](https://umamusume.jp/). I already have a [open-source console app](https://github.com/SimpleSandman/UmaMusumeLoadSqlData) to help reload data into a SQL Server database (which is my preferred RDMS thanks to my DBA days).
